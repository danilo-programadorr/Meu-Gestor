...
- ASSIST-2H-0 adiciona uma ponte local e fail-closed para contexto financeiro
  ...
  como fatos mínimos tipados em centavos inteiros e aliases efêmeros;
  qualquer fonte não confirmada, ID persistido, segredo, terceiro, float ou
  período inválido invalida a montagem sem chamada externa;
