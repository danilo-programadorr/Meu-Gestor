...
> **Decisão FREE-1 (24/08/2026):** esta arquitetura foi retirada do fluxo ativo do aplicativo. Investimentos, proventos, calculadoras e análises são gratuitos; rotas, providers, controllers e Rules ativas não consultam entitlement, compra ou teste. O conteúdo abaixo é histórico técnico reversível. Nenhuma retomada comercial é implícita e qualquer reativação exige decisão e incremento próprios.
...
Este era o desenho comercial anterior ao FREE-1. A integração B3 e integrações com corretoras seguem canceladas. A infraestrutura comercial preservada não é chamada pelo runtime ativo e não torna nenhum recurso pago.
